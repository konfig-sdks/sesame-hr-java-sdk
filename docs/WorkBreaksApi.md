...
|------------- | ------------- | -------------|
| [**list**](WorkBreaksApi.md#list) | **GET** /schedule/v1/work-breaks | List Work Breaks |


<a name="list"></a>
# **list**
> WorkBreaksListResponse list().limit(limit).page(page).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      WorkBreaksListResponse result = client
              .workBreaks
              .list()
              .limit(limit)
              .page(page)
      ...
      System.err.println("Exception when calling WorkBreaksApi#list");
    ...
    try {
      ApiResponse<WorkBreaksListResponse> response = client
              .workBreaks
              .list()
              .limit(limit)
              .page(page)
...
[**WorkBreaksListResponse**](WorkBreaksListResponse.md)
