...
|------------- | ------------- | -------------|
| [**getAll**](RolesApi.md#getAll) | **GET** /core/v3/roles | List Roles |


<a name="getAll"></a>
# **getAll**
> RolesGetAllResponse getAll().limit(limit).page(page).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      RolesGetAllResponse result = client
              .roles
              .getAll()
              .limit(limit)
              .page(page)
      ...
      System.err.println("Exception when calling RolesApi#getAll");
    ...
    try {
      ApiResponse<RolesGetAllResponse> response = client
              .roles
              .getAll()
              .limit(limit)
              .page(page)
...
[**RolesGetAllResponse**](RolesGetAllResponse.md)
